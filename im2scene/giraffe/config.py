...
def get_model(cfg, device=None, len_dataset=0, **kwargs):
    ...
    cam_weight = cfg['training']['cam_weight']
    ...
    if generator is not None:
        generator = models.generator_dict[generator](
            ...
            neural_renderer=neural_renderer, range_u=range_u, range_v= range_v, 
            img_size=img_size, cam_weight = cam_weight, **generator_kwargs)
